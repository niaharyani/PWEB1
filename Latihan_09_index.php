...
<head>
    ...
    <style>
        ...
        .jumbotron-bg{
            background-image: url('logo_fkom.jpg');/*URL gambar latang belakang*/
                ...
                <article>
                    <?php
                        ...
                        if(isset($menu)){
                            ...
                            include "Latihan_09_buku_tamu.php";
                        }elseif($menu == "bursa_kerja"){
                            include "Latihan_09_bursa_kerja.php";
                        }elseif($menu == "cari_alumni"){
                            include "Latihan_09_cari_alumni.php";
                        }
                        else{
                            @include "Latihan_09_home.php";
                        }
